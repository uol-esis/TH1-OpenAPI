...
|  <<converterType>>  
| 
|    REMOVE_GROUPED_HEADER, FILL_EMPTY_ROW, FILL_EMPTY_COLUMN, REMOVE_COLUMN_BY_INDEX, REMOVE_ROW_BY_INDEX, ADD_HEADER_NAME, REMOVE_FOOTER, REMOVE_HEADER, REPLACE_ENTRIES, SPLIT_CELL, REMOVE_INVALID_ROWS, REMOVE_TRAILING_COLUMN, REMOVE_LEADING_COLUMN, MERGE_COLUMNS, TRANSPOSE_MATRIX, PIVOT_LONGER, REMOVE_KEYWORD,  
...
This converter reshapes a pivot matrix into a longer format.

It converts columns representing different categories into a single dimension 
column, and gathers the corresponding values into one or more value columns. 
This allows datasets that are wide or pivoted to be analyzed more easily in 
a long format.

The &#x60;converterType&#x60; MUST be &#x60;PIVOT_LONGER&#x60;.
...
| 
|   List   of <<string>>
| Target column where the numeric values are stored
|     
...
| 
|   Boolean  
| If multiple converters use the same &#x60;columnName&#x60;:   - &#x60;true&#x60; (default): values go into the same column   - &#x60;false&#x60;: creates separate columns (e.g. Kategorie_1, Kategorie_2) 
|     
